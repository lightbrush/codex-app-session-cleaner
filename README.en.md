...
Safely and physically clean a local Codex App session by session ID on Windows and macOS, using a Python-based workflow that moves files into `trash` instead of permanently deleting them.
